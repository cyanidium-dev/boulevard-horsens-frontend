...
type GiftCardCustomerEmailProps = {
  name?: string;
  email: string;
  amountLabel: string;
  date?: string;
...
export function GiftCardCustomerEmail({
  ...
  return (
    <Html lang="da">
      ...
      <Preview>Tak for dit køb af gavekort — Boulevard Beauty Salon</Preview>
      <Body style={main}>
        <Container style={outer}>
          <Section style={card}>
            ...
            <Section style={infoBox}>
              ...
              <Text style={rowNoMargin}>
                <strong style={labelStrong}>Gavekort:</strong> {amountLabel}
              </Text>
            </Section>

            {date ? (
              <Text style={meta}>
                Betalt den <span style={metaStrong}>{date}</span>
              </Text>
            ) : null}
