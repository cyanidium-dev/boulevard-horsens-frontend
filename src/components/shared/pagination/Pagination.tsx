  ...
  return (
    <>
      ...
      >
        <button
          aria-label="left"
          className={`group enabled:cursor-pointer flex justify-center items-center size-[54px] border-[1.5px] border-black rounded-full 
        ...
        >
          <ShevronIcon className="text-white group-disabled:text-black -rotate-90 transition duration-300 ease-in-out" />
        </button>
            ...
            item === "..." ? (
              ...
              <button
                ...
                className={`cursor-pointer text-[14px] font-normal leading-[133%] transition duration-300 ease-in-out
                  ${
                    currentPage === item
                      ? "bg-black text-white rounded-full size-8 flex items-center justify-center"
                      : "xl:hover:opacity-85"
                  }`}
              >
                {item}
        ...
        <button
          aria-label="right"
          className={`group enabled:cursor-pointer flex justify-center items-center size-[54px] rounded-full border-[1.5px] border-black transition duration-300 ease-in-out
